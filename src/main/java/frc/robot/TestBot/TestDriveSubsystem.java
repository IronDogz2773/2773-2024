...
public class TestDriveSubsystem extends SubsystemBase {
  ...
  private  CANSparkMax leftForMotor = new CANSparkMax(Constants.leftFrontWheelCANID, MotorType.kBrushless);
  private  CANSparkMax rightForMotor = new CANSparkMax(Constants.rightFrontWheelCANID, MotorType.kBrushless);
  private final CANSparkMax leftBackMotor = new CANSparkMax(Constants.leftBackWheelCANID, MotorType.kBrushless);
  private final CANSparkMax rightBackMotor = new CANSparkMax(Constants.rightBackWheelCANID, MotorType.kBrushless);
